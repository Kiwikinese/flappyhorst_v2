...
/**
 * HighScore-Screen des Spiels. Sobald der Spieler im Hauptmenü auf den Button Highscore klickt.
 * Hier werden dem Spieler sein zuletzt erreichter Score und sein Highscore angezeigt.
 *
 */
public class HighscoreState extends State {
    ...
    public void render(SpriteBatch batch) {
        ...
        this.font.draw(batch, "Zuletzt erreichte Punktzahl:\n\t" + currentScore, 50, Gdx.graphics.getHeight()-600);
        this.font.draw(batch, "Aktueller Highscore:\n\t" + highscore, 50, Gdx.graphics.getHeight()-900);
